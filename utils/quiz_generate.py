...
async def generate_answer(topic_key: str, TOPICS: dict) -> str:
    ...
    prompt = (
        ...
        "Иногда это может быть простой факт, иногда — необычный или неожиданный факт.\n"
        "Не давай ответ сразу.\n"
        "Пиши только сам вопрос.\n"
        "Без вступления и без пояснений.\n"
        "Старайся, чтобы вопросы не повторялись.\n"
        "Старайся чередовать типы вопросов: фактический, логический, загадка, интересный факт."
    )
